...
def main():
        ...
        for ami_instance_name, ami_instance_ip in instance_ips:
            if ami_instance_ip in instance_ips_to_poll:
                ...
                try:
                    ...
                    logging.exception(f'{ami_instance_name} encountered an error, Will retry this step later', exp)
                    continue
    ...
    if failure:
        logging.critical('One or more instance were dropped by amazon, if raised often - report to team leader.')
        sys.exit(1)
